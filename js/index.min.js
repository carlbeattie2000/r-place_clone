(function () {
  ...
  const main$4 = new Canvas(shared_state.canvas, config.canvas_width, config.canvas_height);
  ...
  const main$3 = new Coordinates(shared_state.canvas, shared_state.coordinates_display);
  ...
  const main$2 = new Storage(config.env_mode);
  ...
  class Draw {
    ...
    init() {
      ...
      const loadedData = main$2.loadDataFromLocalStorage();
    ...
    drawEvent() {
      ...
      this.canvas.addEventListener("mousedown", (e) => {
        ...
        const {x, y} = main$3.getCursorCoordinates(e);

        this.drawRect(x, y, shared_state.selectedColor);

        main$2.saveDataToLocalStorage({x, y, color: shared_state.selectedColor});
  ...
  const main$1 = new Draw(shared_state.canvas);
